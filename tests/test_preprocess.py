...
from gatk_sv_profile.preprocess import (
...
def test_run_preprocess_without_tracks(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("gatk_sv_profile.preprocess.get_gatk_version", fake_get_gatk_version)
    monkeypatch.setattr("gatk_sv_profile.preprocess.run_command", fake_run_command)
